...
const journals = [
  'C. Wang and N. Aouf, "Depth-Enhanced Deep Learning Approach For Monocular Camera Based 3D Object Detection", has been accepted for publication in Springer, Journal of Intelligent & Robotic Systems.',
  'C. Wang and N. Aouf, "Explainable Deep Adversarial Reinforcement Learning Approach for Robust Autonomous Driving," in IEEE Transactions on Intelligent Vehicles, 2024, doi: 10.1109/TIV.2024.3379367',
  'D Rondao, L He, N Aouf   AI-based monocular pose estimation for autonomous space refuelling – Elsevier, Acta Astronautica, 2024',
  'H. Courtois, N. Aouf, K. Ahiska and M. Cecotti, "NDT RC: Normal Distribution Transform Occupancy 3D Mapping With Recentering," in IEEE Transactions on Intelligent Vehicles, vol. 9, no. 1, pp. 2999-3009, Jan. 2024, doi: 10.1109/TIV.2023.3250326.',
  ...
  'Abdelhafid Zenati, Nabil Aouf and David Sanchez de la Llana "Validation of Neural Network Controllers for Uncertain Systems Through Keep- Close Approach : Robustness Analysis and Safety Verification", under second revision in IEEE Transactions on Control Systems Technology',
  'Abdulsalam Mahmoud, Kenan Ahiska and Nabil Aouf Novel UAV Integrated Deep Network Detection and Relative Position Estimation Approach for Weeds, in IMECHE Journal of Aerospace Engineering, SAGE, Volume 237, Issue 10, 2023, https://doi.org/10.1177/09544100221150284.',
  'Abdelhafid Zenati, Mohamed Tadjine, Nabil Aouf, and Taous, Meriem Laleg On the Admissibility and Stability of Multi-Agent Nonlinear Interconnected Positive Systems with Heterogeneous Delays, in IEEE Transactions on Automatic Control, Early access, 30 May 2023. DOI: 10.1109/TAC.2023.3281514',
  'Duarte Rondao, Nabil Aouf and Mark Richardson ChiNet: Deep Recurrent Convolutional Learning for Multimodal Spacecraft Pose Estimation, IEEE Transactions on Aerospace and Electronic Systems, Volume: 59, Issue: 2, April 2023',
  'Zakaria Chekakta, Abdelhafid Zenati, Nabil Aouf and Olivier Dubois-Matra Robust Deep Learning LiDAR-based Pose Estimation for Autonomous Space Landers, Accepted in Elsevier Acta Astronautica, Volume 201, p. 59-74, 2022',
  'Hugo Courtois, Nabil Aouf, Kenan Ahiska and Marco Cecotti, OAST: Obstacle Avoidance System for Teleoperation of UAVs, in IEEE Transactions on Human-Machine Systems, accepted for publication, Volume: 52, Issue: 2, April 2022.',
  'Jianing Song, Duarte Rondao and Nabil Aouf Deep Learning-based Spacecraft Relative Navigation Methods: A Survey, Acta Astronautica Volume 191, Pages 22-40, February 2022 DOI: 10.1016/j.actaastro.2021.10.025',
  ...
  'O. Kechagias-Stamatis, N. Aouf and M. Richardson 3D Automatic Target Recognition for Future LIDAR Missiles IEEE Transactions of Aerospace Electronic Systems',
...
const conferences = [
  'Lei He, Duarte Rondao, Nabil Aouf A Novel Mechanism for Orbital AI-based Autonomous Refuelling, AIAA SCITECH 2023 Forum, 2211',
  ...
  'Maxwell Hogan, Duarte Rondao, Prof. Nabil Aouf, Olivier Dubois-Matra Using Convolutional Neural Networks for Relative Pose Estimation of a Non-Cooperative Spacecraft with Thermal Infrared Imagery 11th International ESA Conference on Guidance, Navigation & Control Systems, 2020',
  'Masoud Sotoodeh-Bahraini, Nabil Aouf, Axel Beauvisage, and Shashank Govindara Distributed Cooperative Visual Odometry for Planetary Exploration Rovers 11th International ESA Conference on Guidance, Navigation & Control Systems, 2020',
  'Axel Beauvisage, Kenan Ahiska, Nabil Aouf: Multimodal tracking framework for visual odometry in challenging illumination conditions. ICRA 2020: 11133-11139',
  'Abdulsalam, M. and Aouf, N. (2020). Deep Weed Detector/Classifier Network for Precision Agriculture. 2020 28th Mediterranean Conference on Control and Automation (MED) 15-18 September, Saint-Raphaël, FRANCE.',
  ...
  'Duarte Rondao and Nabil Aouf. "Multi-View Monocular Pose Estimation for Spacecraft Relative Navigation", 2018 AIAA Guidance, Navigation, and Control Conference, AIAA SciTech Forum, (AIAA 2018-2100) https://doi.org/10.2514/6.2018-2100',
  ...
  'Beauvisage, A., Aouf, N., Courtois, H “Multi-spectral visual odometry for unmanned air vehicles” 2016 IEEE International Conference on Systems, Man, and Cybernetics, SMC 2016 - Conference Proceedings',
  'Bergé, L.-P., Aouf, N., Duval, T., Coppin, G. “Generation and VR visualization of 3D point clouds for drone target validation assisted by an operator” 2016 8th Computer Science and Electronic Engineering Conference, CEEC 2016 - Conference Proceedings',
  'Ruiz, J.A.D., Aouf, N. “Real-time setup with PD and backstepping control for a Pelican quadrotor” ICINCO 2017 - Proceedings of the 14th International Conference on Informatics in Control, Automation and Robotics',
  'Ruiz, J.A.D., Aouf, N. “Unscented kalman filter for vision based target localisation with a quadrotor” ICINCO 2017 - Proceedings of the 14th International Conference on Informatics in Control, Automation and Robotics',
  ...
  'Bergé, L.-P., Aouf, N., Duval, T., Coppin, G. “Visualization of 3D point clouds sensed by a laser: Effect of stereo and head tracking rendering on a target research task” IHM 2016 - Actes de la 28ieme Conference Francophone sur l\'Interaction Homme-Machine',
  'Feetham, L., Aouf, N., Dubois-Matra, O., Bourdarias, C. “Image datasets for autonomous planetary landing algorithm development” Proceedings of 2016 7th International Conference on Mechanical and Aerospace Engineering, ICMAE 2016, 7549615, pp. 627-637',
  'Kechagias-Stamatis, O., Aouf, N. “Histogram of distances for local surface description” Proceedings - IEEE International Conference on Robotics and Automation, pp. 2487-2493, 2016',
  'Almutairi, S.H., Aouf, N. “Enhancing the aircraft\'s stability and controllability against actuator faults using robust flight control” Proceedings of 2016 IEEE International Conference on Control and Robotics Engineering, ICCRE 2016, 7476136',
  'O. Kechagias-Stamatis and N. Aouf, “Fast 3D object matching with Projection Density Energy,” in 23rd Mediterranean Conference on Control and Automation (MED), 2015.',
  'S. Almutairi and N. Aouf, “Aircraft Robust Flight Tracking Control against Actuator Efficiency Faults” in the International Conference on System theory, Control, and Computing, Romania, 16-19 Oct 2015.  (Accepted).',
  'S. Almutairi and N. Aouf, “Design and Non-Linear Simulations of a Fault-Tolerant Flight Control,” in the International Conference of Mechanical and Aerospace Engineering ICMAE, Madrid, Spain, 18-19 July 2014.',
  'S. Almutairi and N. Aouf, “Fault-Tolerant Flight Control Design against Actuator Impairments using Optimal Control and Fault Compensation,” in The 11th IEEE International Conference on Control & Automation, Taichung, Taiwan, 18-20 June 2014.',
  'S. Almutairi and N. Aouf, “ State Feedback Optimal Flight Control System Design with Tracking Feature,” in The 7th Saudi Students Conference, Edinburgh, United Kingdom, 1-2 February 2014.',
  'Vitanov and N. Aouf Fault diagnosis for MEMS INS using unscented Kalman filter enhanced by Gaussian process adaptation. AHS 2014: 120-126',
  'Vitanov and N. Aouf Fault diagnosis and recovery in MEMS inertial navigation system using information filters and Gaussian processes IEEE Control and Automation (MED), 2014 22nd Mediterranean Conference of, pp: 115-120',
  'A.Amamra and N. Aouf, “Robust and Sparse RGBD Data Registration of Scene Views,” in 2013 17th International Conference on Information Visualisation, 2013, pp. 488–493.',
  'A.Amamra and N. Aouf, “Indoor 3D Augmented Reality,” in 11th Electro Optics and Infrared Conference, Shrivenham, Defence Academy of the UK, Jun. 2013.',
  'A.Amamra and N. Aouf, “Real-Time Robust Tracking with Commodity RGBD Camera,” in 2013 IEEE International Conference on Systems, Man, and Cybernetics, 2013, pp. 2408–2413.',
  'Amamra and N. Aouf, “RGBD sensors correction with Gaussian process regression,” in Proceedings ELMAR-2014, 2014, pp. 1–4.',
  'Amamra, T. Mouats, and N. Aouf, “GPU based GMM segmentation of kinect data,” in Proceedings ELMAR-2014, 2014, pp. 1–4.',
  'Amamra, T. Mouats, and N. Aouf, “Real-Time Background/Foreground Segmentation of RGBD Data”, in Proceedings ICSTCC, 2014.',
  'Mohammed Boulekchour and Nabil Aouf. “L-infinity Norm Based Solution for Visual Odometry” Computer Analysis of Images and Patterns – 15th International Conference, CAIP 2013, York, UK',
  ...
  'L. Chermak, N. Aouf. “Feature Enhanced feature detection and matching under extreme illumination conditions with a HDR imaging sensor” In 11th IEEE International Conference on Cybernetic Intelligent Systems (CIS), pages. 64–69, August 2012.',
  'L. Chermak, N. Aouf. “A Minimax Solution for Stereo Based Motion Estimation” In11th IEEE International Conference on Cybernetic Intelligent Systems (CIS), pages. 112–117, August 2012.',
  'L. Chermak, N. Aouf. “Stereo Visual Odometry Solution Based on Double Dogleg Local Bundle Adjustment Scheme” In12th Electro-Optics & Infrared Conference, Shrivenham, UK Defence Academy, June 2014.',
  'Vitanov and N. Aouf “Fault detection and isolation in inertial navigation systems with SDRE non-linear filter” 5th European Conference for Aeronautics and Space Sciences (EUCASS). Munich, Germany, July 2013.',
  'Luke Feetham, Nabil Aouf, Clement Bourdarias, and Thomas Voirin. “Single camera absolute structure from motion using H-infinity data fusion for a next generation planetary lander” 5th European Conference for Aeronautics and Space Sciences (EUCASS). Munich, Germany, July 2013.',
  'Luke Feetham, M., Nabil Aouf, Clement Bourdarias, Thomas Voirin, and Olivier Dubois-Matra.”Self tuning, recursive structure from motion for hazard detection in autonomous planetary descent” GNC 2014: 9th International ESA Conference on Guidance Navigation & Control Systems. Porto, Portugal, June 2014.',
  'Mouats, T., & Aouf, N. (2013). “Multimodal stereo correspondence based on phase congruency and edge histogram descriptor” 2013 IEEE International Conference on Information Fusion, 1981–1987.',
  'Mouats, T., & Aouf, N. (2013). “Cross-Spectral Stereo Matching Based on Local Self-Similarities and Image Moments” IEEE International Conference on Systems, Man, and Cybernetics, 4048–4053.',
  'Mouats, T., & Aouf, N. (2014). “Robust feature matching for aerial visual odometry” In Proceedings of IEEE ELMAR-2014 (pp. 1–4).',
  'Mouats, T., & Aouf, N. (2014). “Fusion of thermal and visible images for day/night moving objects detection” In IEEE Sensor Signal Processing for Defence (SSPD) (pp. 1–5).',
  'Amamra, A., Mouats, T., & Aouf, N. (2014). “GPU based GMM segmentation of kinect data”. In Proceedings of IEEE ELMAR-2014 (pp. 1–4).',
  'Oualid Araar and Nabil Aouf , “Full linear control of a quadrotor UAV, LQ vs H∞ ”, In International Conference on Control (UKACC), July 2014.‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬',
  'Oualid Araar and Nabil Aouf, “Visual Servoing of a Quadrotor UAV for the Tracking of Linear Structured Infrastructures”, In IEEE International‬ Conference on Systems, Man, and Cybernetics (SMC), Oct 2013‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬',
  'Oualid Araar and Nabil Aouf, “Quadrotor control for trajectory tracking in presence of wind disturbances”, In International Conference on Control‬ (UKACC), July 2014.‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬',
  'Oualid Araar and Nabil Aouf, “A new hybrid approach for the visual servoing of VTOL UAVs from unknown geometries”, 22nd Mediterranean‬ Conference of Control and Automation (MED), June 2014.‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬',
  'Oualid Araar and Nabil Aouf, “Visual servoing of a Quadrotor UAV for autonomous power lines inspection,” 22nd Mediterranean Conference of‬ Control and Automation (MED), June 2014.‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬‬',
  'Riad Azzam and Nabil Aouf Acoustic Detection and Localization Enhanced by Video Analysis (Systems, Man, and Cybernetics (SMC), 2013 IEEE International Conference)',
  'Riad Azzam and Nabil Aouf The Gaussian Processes for Acoustic Localisation and Tracking in Wireless Sensor Network ( 5th International Conference on Imaging for Crime Detection and Prevention (ICDP 2013))',
  'Riad Azzam and Nabil Aouf  Non parametric tool for vision detection analysis (ELMAR (ELMAR), 2014 56th International Symposium)',
  'Riad Azzam and Nabil Aouf  Embeded fusion of visual and acoustic for active acoustic source detection with SGGMM (ELMAR (ELMAR), 2014 56th International Symposium)',
  'Xiaodong Li and Nabil Aouf “Cooperative vSLAM Based on UAV Application” IEEE International Conference on Robotics and Biomimetics (ROBIO), China, 2012.',
  'Xiaodong Li and Nabil Aouf “Estimation Analysis in VSLAM Based on UAV Application” IEEE International Conference on Multisensor Fusion and Information Integration, Germany, Sept 2012.',
  'Diego Rodriguez and Nabil Aouf “Robust Ego-Motion for Large-Scale Trajectories” IEEE International Conference on Multisensor Fusion and Information Integration, Germany, Sept 2012.',
  'Xiaodong Li and Nabil Aouf “SIFT/SURF Feature Analysis in Visible and Infrared Imaging for UAVs” IEEE International Conference on Cybernetic Intelligent Systems, Ireland, August, 2012.',
  'Lounis Chermak and Nabil Aouf “Enhanced Feature Detection and Matching Under Extreme Illumination Conditions With a HDR Imaging Sensor” IEEE International Conference on Cybernetic Intelligent Systems, Ireland, August, 2012.',
  'Xiaodong Li and Nabil Aouf “3D Mapping based VSLAM for UAVs” IEEE 20th Mediterranean Conference on Control and Automation. Spain, July 2012.',
  'Y. Morsly N. Aouf and MS. “Djouadi Dynamic Decentralized/Centralized Free Conflict UAV’s Team Allocation”, IEEE International Instrumentation and Measurement Technology Conference, Austria, May 2012.',
  'Gray, Aouf, Richardson, Butters, Walmsley, Nicholls, Daya “Feature Based Tracking Algorithms for Imaging Infrared Anti-Ship Missiles” SPIE Security & Defence, Prague, Czech Republic, Sept 2011.',
  'Saad Imran and Nabil Aouf “A recursive least squares solution for recovering robust planar homographies” Taros Conference, Sheffield, UK, August 31, 2011.',
  'Karim Nemra and Nabil Aouf “Adaptive Decentralised Cooperative Vision Based Simultaneous Localization and Mapping for Multiple UAVs” IEEE Mediterranean Conference on Control and Automation, GREECE, June, 2011.',
  'M. S. Kemouche, N. Aouf, “A GMM Approximation with Merge and Split for Nonlinear Non-Gaussian Tracking”, accepted, International Conf. on Information Fusion, Fusion2010, Edinburgh, UK, 2010.',
  'M. A Shah, A. Tsourdos, D. James and N. Aouf “On the Definition of Curve’s Frame at the Points of inflection” 8th IFAC Symposium on Automatic Control in AeroSpace (ACA), Nara, Japan, 6 – 10 September 2010.',
  'D. Rodriguez and N. Aouf “Robust Harris-Surf Features for Robotic Vision Based Navigation” 13th International IEEE Annual Conference on Intelligent Transportation Systems, Madeira Island, Portugal, September 19-22, 2010.',
  'M.S. Kemouche, N. Aouf “A Gaussian Mixture Based Optical Flow Modelling For Background/Foreground Image Segmentation” Under review in the IET International Conference on Imaging for Crime Detection and Prevention, December 2009.',
  'Y. Morsly, N. Aouf and M. Djouadi “On The Optimal Placement of Multiple Visual Sensor Based Binary Particle Swarm Optimization” in IFAC International Conference on Intelligent Control and Signal Processing, Turkey, 2009.',
  'Nemra and N. Aouf “Robust Invariant Automatic Image Registration, sensing and super resolution” in 6th International Symposium on Mechatronics and its Applications, Mars 2009.',
  'Nemra and N. Aouf “Robust Cooperative UAVs SLAM” in IEEE International Conference on. Cybernetic Intelligent Systems, September 09.',
  'Nemra and N. Aouf “Robust Feature Extraction and Correspondence for UAV Map Building” IEEE, Mediterranean Conference June 2009.',
  'F. Wang, N. Aouf and A. Tsourdos “Centralized/Decentralized Control for Spacecraft Formation Flying Near Sun-Earth L2 Point” IEEE Conference on Industrial Electronics and Applications, China 2009.',
  'M. Kharbat and Nabil Aouf “Variational model for robust computation of optical Flow” Accepted in IEEE International Conference on. Cybernetic Intelligent Systems, September 09.',
  'M. S. Kemouche, N. Aouf, “A Gaussian Mixture based optical flow modeling for object detection”, 3rd Int. Conf. on Imaging for Cream Detection and Prevention, ICDP2009, London, UK, 3rd Dec. 2009.',
  'M. Shah and N. Aouf “3D Cooperative Pythagorean Hodograph Path Planning and Obstacle Avoidance for Multiple UAVs” in IEEE International Conference on. Cybernetic Intelligent Systems, September 09.',
  'M. Shah and N. Aouf “Dynamic Cooperative Perception and Path Planning for Collision Avoidance” 6th International Symposium on Mechatronics and its Applications, Mars 2009.',
  'A.Nemra, N. Aouf, A. Tsourdos, B.White “Robust Nonlinear Filtering for INS/GPS UAV Localization” 16th Mediterranean Conference on Control and Automation, June 25-27, 2008, Congress Centre, Ajaccio, France.',
  'Immanuel Ashokaraj, Samuel B. Lazarus, Antonios Tsourdos, Rafal Zbikowski, Peter Silson, Aouf Nabil, Brian A. White, “Robot localisation and mapping using data fusion via integration of covariance intersection and interval analysis for a partially known map”, European Control Conference 2007, Kos, Greece on July 2-5, 2007.',
  'M. Kharbat, Nabil Aouf, Antonios Tsourdos, Brian White “Sphere Detection and Tracking for a Space Capturing Operation” Proceedings of IEEE International Conference on Advanced Video and Signal based Surveillance, London, pp: 182-187, September 2007.',
  'N. Aouf, V. Sazdovski, A. Tsourdos and B. White, “Low Altitude Airborne SLAM with INS Aided Vision System”, Guidance, navigation and Control Conference, AIAA-2007-6790, 2007.',
  'S. Lazarus, A. Tsourdos, N. Aouf, R. Zbikowski, and B. White, “Autonomous Aerial Vehicle Localisation and Mapping” Guidance, navigation and Control Conference, AIAA-2007-6792, 2007.',
  'M. Kharbat, Nabil Aouf, Antonios Tsourdos, Brian White “Robust Brightness Description for Computing Optical Flow”, Accepted for the 19th The British Machine Vision Conference, 1st-4th September 2008.',
  'M.S. Kemouche, N. Aouf, A. Tsourdos, B. White “A hybrid Kalman/gamma Hinfinity filter for manoeuvring target tracking” Proceedings of IEEE International Conference on Signal Processing and Communication, pp. 1267-1270, 24-27 November, 2007, Dubai, United Arab Emirates.',
  'M.S. Kemouche, N. Aouf “A GMM-Based Multitarget Tracking Algorithm and Analysis” Proceedings of the 11th International Conference on Information Fusion, Germany, 30June-3July, 2008.',
  'M. Kharbat, N.Aouf, A.Tsourdos and B.White “Sphere Detection and Tracking for a Space Capturing Operation” IEEE International Conference Advanced Video and Signal based Surveillance 2007.',
  'N. Aouf, V. Sazdovski, A. Tsourdos and B. White,” Low Altitude Airborne SLAM with INS aided Vision System” AIAA-Guidance Navigation and Control Conference 2007.',
  ...
  'Z. Li Z., W.F. Xie. And N.Aouf, “A Neural Network Based Hand-Eye Calibration Approach in Robotic Manufacturing Systems”, Conference of Canadian Society of Mechanical Engineers (CSME), Calgary, 2006.',
  'N. Aouf, H. Rajabi and C. Perron “Visual servoing with a Camera mounted on indusrual 6DOF robot” IEEE international conference on robotic, automation and vision Singapore Dec 2004.',
  'Moore, B. Boulet, N. Aouf, P. Girard, R. DiRaddo, “Multivariable H-infinity Control of the Thermoforming Reheat Process”. 3rd DCDIS Int. Conf. on Engineering Applications and Computational Algorithms. Guelph, Ontario, May 15-18 2003.',
  'N. Aouf., “Closed-loop Plasma spray control” Proceedings Surftec Workshop. Sep 2003.',
  'N. Aouf “Fault Diagnosis and Isolation for thermoforming process” IEEE international control and automation conference Montreal 2003.',
  'N. Aouf, and C.A. Rabbath “ Intelligent strategy for BTT missile control problem” IEEE international control and automation conference Montreal 2003.',
  'N. Aouf, R. Diraddo and B. Boulet “Neural control strategy for a thermoforming process” IEEE Conference on Control Applications Turkey 2003.',
  'M. Tuner, N. Aouf, D. Bates, I. Postlethwaite and B. Boulet “Switching Technique for a VSTOL Aircraft”Conference on Control applications September 2002.',
  'N. Aouf, D. Bates “Scheduling-partitioning technique for Harrier VSTOL aircraft” American Control Conference ACC 2002.',
  'N. Aouf, B. Boulet, R. Botez “Gain Scheduling technique for B1 Flexible Aircraft” American Control Conference ACC 2002.',
  'N. Aouf, B. Boulet “Uncertainty models for flexible structures” in proceedings of AiAA Guidance, Navigation and Control 2001.',
  'N. Aouf, D. Bates and I. Postlethwaite “Observer form scheduling for an Hinfinity loopshaping integrated flight and propulsion control law” in proceedings of AiAA Guidance, Navigation and Control 2001.',
  'N. Aouf, B. Boulet, R. Botez “Model-Controller Reduction for Flexible Aircraft Achieving Robust Performance” in proceedings of American Control Conference ACC 2001.',
  'N. Aouf, B. Boulet, R. Botez “H2 and H-infinity –Optimal Gust Load Alleviation for a Flexible Aircraft” in proceedings of American Control Conference ACC 2000.',
  'N. Aouf, B. Boulet, R. Botez “Robust gust alleviation for flexible aircraft” Casi (Canadian Aeronautics and Space Institute) conference 2000.'
];

const generateSequentialList = (items) => {
  let count = 1;
  return items.map((item) => `${count++}. ${item}`);
};

const Publications = () => {
  const numberedJournals = generateSequentialList(journals);
  const numberedConferences = generateSequentialList(conferences);

  return (
    <div className="publications-page">
      <section className="publications-hero text-center" style={{ backgroundImage: `url(${publicationsBanner})` }}>
        <div className="publications-container mx-auto">
          <h3 className="text-5xl font-bold py-4 px-8 inline-block mt-12">Publications</h3>
        </div>
      </section>
