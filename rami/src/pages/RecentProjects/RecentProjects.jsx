    ...
    <div className="recent-projects">
      ...
      <section className="project-gallery py-16 bg-white text-center">
        <div className="container mx-auto px-4 project-section py-16 bg-gradient-to-r from-blue-200 via-gray-200 to-red-200 w-full">
          ...
          <div className="project-item">
            <h3 className="text-2xl font-bold mb-4">02 Adversarial Learning for Autonomous System</h3>
          ...
          <div className="project-item">
            <h3 className="text-2xl font-bold mb-4">03 PRO-ACT – Planetary Robots Deployed for Assembly and Construction Tasks</h3>
          ...
          <div className="project-item">
            <h3 className="text-2xl font-bold mb-4">04 Artificial Intelligence for Detection of Explosive Device AIDED</h3>
          ...
          <div className="project-item">
            <h3 className="text-2xl font-bold mb-4">05 Trust Through Explainability of AI Based Space Software</h3>
          ...
          <div className="project-item">
            <h3 className="text-2xl font-bold mb-4">06 OIBAR: Orbital AI-based Autonomous Refuelling</h3>
          ...
          <div className="project-item">
            <h3 className="text-2xl font-bold mb-4">07 Deep Neural Network Based LIDAR Navigation for Space Landing operations</h3>
      ...
      <section className="other-research py-16 bg-gradient-to-r from-purple-200 via-pink-200 to-red-200 text-center">
        <div className="container mx-auto px-4">
          ...
          <div className="research-item mb-16">
            <h3 className="text-2xl font-bold mb-4">01 Trajectory Planning and Perception for Autonomous Vehicles</h3>
          ...
          <div className="research-item mb-16">
            <h3 className="text-2xl font-bold mb-4">02 Drl for Cubesats</h3>
          ...
          <div className="research-item mb-16">
            <h3 className="text-2xl font-bold mb-4">03 Explainable AI for Drones 2D/3D Recognition and Scene Understanding</h3>
