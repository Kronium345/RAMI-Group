      ...
      <section className="other-research py-16 text-center">
        <div className="container mx-auto px-4">
          ...
          <div className="research-item mb-16">
            ...
            <p className="mb-4">
              This project aims to develop artificial intelligence based autonomous driving in complex urban scenarios. To accomplish the objective self-driving car needs to maintain high robustness while facing challenges from dynamic transportation and critical weather conditions.
            </p>
            <p className="mb-4">
              The solution consists of a real-time perception system and a novel decision-making model. To enhance the understanding of surrounding environment, vision-based depth estimation and semantic segmentation approaches are acquired for scene geometry and semantic information. Then fed from the perception model, planning system generates driving commands controlling the vehicle.
            </p>
          </div>
          ...
          <div className="research-item mb-16">
            ...
            <p className="mb-4">
              This control method allows for simultaneous, autonomous control that can appropriately actuate a spacecraft even in situations the agent has not previously encountered. The rendezvous controller consists of a Twin-Delayed Deep Deterministic Policy Gradient (TD3) agent that would be able to control a CubeSat and achieve rendezvous with the target satellite.
            </p>
            <p className="mb-4">
              The attitude controller consists of a quaternion-based TD3 agent; it has shown the ability to perform large angle slew manoeuvres and achieve pointing accuracies of less than five degrees error while resisting environmental perturbations.
            </p>
            <p className="mb-4">
              The controller’s feasibility was assessed using a six-Degree-of-Freedom (6-DoF) relative spacecraft dynamics model, along with a model of the spacecraft’s environment. The agents were trained in a simplified environment and subsequently tested in an environment that incorporated disturbance models and actuator noise, providing an evaluation of their capabilities in realistic conditions.
            </p>
          </div>
        </div>
      </section>
